<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-slate-900 text-slate-100 
        ...
        <ul class="menu w-full grow gap-1">
            <!-- Dashboard Item -->
            <li class="{{ request()->routeIs('admin.dashboard') ? 'bg-slate-700 rounded-lg' : '' }}">
            ...
            <!-- Kategori item -->
            <li class="{{ request()->routeIs('admin.categories.*') ? 'bg-gray-700 rounded-lg' : '' }}">
            ...
            <!-- Event item -->
            <li class="{{ request()->routeIs('admin.events.*') ? 'bg-gray-700 rounded-lg' : '' }}">
            ...
            <!-- Lokasi item -->
            <li class="{{ request()->routeIs('admin.lokasi.*') ? 'bg-gray-700 rounded-lg' : '' }}">
                <a href="{{ route('admin.lokasi.index') }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <circle cx="12" cy="10" r="3" fill="none" stroke="currentColor" stroke-linecap="round"
            ...
            <!-- payment type item -->
            <li class="{{ request()->routeIs('admin.payment-types.*') ? 'bg-gray-700 rounded-lg' : '' }}">
                <a href="{{ route('admin.payment-types.index') }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" d="M2 7h20v10H2zM2 7l4-4h12l4 4M6 11h.01M10 11h.01" />
                    </svg>
            ...
            <!-- History item -->
            <li class="{{ request()->routeIs('admin.histories.*') ? 'bg-gray-700 rounded-lg' : '' }}">
